...
class TestSiteLayout(unittest.TestCase):
    ...
    def test_page_site_layout_invalidate_catalog_coutner(self):
        pass

    def test_default_site_layout(self):
        pass
    
    def test_default_site_layout_cached(self):
        pass

    def test_default_site_layout_invalidate_mtime(self):
        pass

    def test_default_site_layout_invalidate_fti_mtime(self):
        pass

    def test_default_site_layout_invalidate_registry_key(self):
        pass

    def test_default_site_layout_invalidate_catalog_coutner(self):
        pass
